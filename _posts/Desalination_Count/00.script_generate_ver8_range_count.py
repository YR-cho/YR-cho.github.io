...
sys.stdout = open(INPUT_FILE+"_NaCl_COUNT"+'.csv', "w")
...
import sys
from collections import Counter
sys.stdout = open(INPUT_FILE+"_Water_COUNT"+'.csv', "w")


# (WMC) WATER_MOLECULE_COUNT
WMC1 = Counter(result1['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC2 = Counter(result2['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC3 = Counter(result3['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC4 = Counter(result4['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC5 = Counter(result5['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC6 = Counter(result6['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC7 = Counter(result7['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC8 = Counter(result8['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC9 = Counter(result9['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC10 = Counter(result10['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC11 = Counter(result11['subst_name'])['T5P'] / WATER_ATOM_COUNT
WMC12 = Counter(result12['subst_name'])['T5P'] / WATER_ATOM_COUNT
...
######################################################
## ANALYSIS 4
## Interacted Water Mol mass / Cluster Mol mass (Water+BMIM+Tf2N) X 100  
######################################################


import sys
from collections import Counter
sys.stdout = open(INPUT_FILE+"_Water_Absortion"+'.csv', "w")
