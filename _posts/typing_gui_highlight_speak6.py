...
class TypingApp:
    ...
    def setup_typing_screen(self):
        ...
        self.text_input = tk.Text(self.root, height=2, font=("Courier New", 16), wrap="word", spacing1=5, spacing3=5)
        ...
        self.pass_button = tk.Button(self.button_frame, text="Pass", command=self.on_pass)
